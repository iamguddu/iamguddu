...
import com.example.gudduroy.ecommerceapp.Model.Cart;
import com.example.gudduroy.ecommerceapp.Prevalent.Prevalent;
import com.example.gudduroy.ecommerceapp.ViewHolder.CartViewHolder;
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Cart, CartViewHolder> adapter
            ...
            protected void onBindViewHolder(@NonNull CartViewHolder holder, int position, @NonNull final Cart model) {
                ...
                int oneTypProductPrice = ((Integer.valueOf(model.getPrice()))) * Integer.valueOf(model.getQuantity());
                overTotalPrice = overTotalPrice + oneTypProductPrice;
